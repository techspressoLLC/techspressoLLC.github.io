const coffeeBeans = [
    {
        ...
        description: 'ASMUCAFE（アスムカフェ）は、コロンビア・カウカ県エル・タンボ地域の女性コーヒー生産者によって2009年に設立された団体です。女性の経済的自立と社会的地位向上を目的に、環境へ配慮した持続可能な栽培で高品質なコーヒーを生産しています。相互扶助の精神を大切にしながら地域社会にも貢献する姿勢が評価され、「フロリアーダ（花で彩られたようなコーヒー）」の名が付けられています。',
        roastProfile: [
            '投入温度: 200C',
            'ドライエンド: 4:30',
            '1ハゼ: 8:20',
